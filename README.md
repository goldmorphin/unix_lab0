...
Чему мы научились? Мы познакомились с крайне полезным инструментом Docker, научились создавать контейнеры используя сторонние репозитории и заливать их на свой. Получили представления о работе с файлами в системе Linux и научились протоколировать вывод команд.
